...
namespace JewelryStore.DAL.Migrations
{
    ...
    [Migration("20250619233146_AddJwtAuthentication")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("JewelryStore.DAL.Data.Models.RefreshToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("JewelryStore.DAL.Data.Models.User", b =>
                {
            ...
            modelBuilder.Entity("JewelryStore.DAL.Data.Models.RefreshToken", b =>
                {
                    b.HasOne("JewelryStore.DAL.Data.Models.User", "User")
            ...
            modelBuilder.Entity("JewelryStore.DAL.Models.Order", b =>
                {
                    ...
                    b.HasOne("JewelryStore.DAL.Data.Models.User", null)
                        .WithMany("Orders")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Restrict);
